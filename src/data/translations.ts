...
const translations : { [key: string]: Translation} = {
  en: {
    ...
    "meta_description": "Louis Grasset, freelance front end web developer. Development tailored to your needs.",
    "language_label": "English",
    "language_code": "en_US",
    "alert_contact_text": "Your message has been sent.",
    "modal_contact_title": "Let's break the ice !",
    "modal_contact_subtitle": "Are you more social medias or contact form? It's up to you.",
    ...
    "studies_mastercim_label": "Master 2 Conception and Multimedia Integration",
    ...
    "about_headline_subtitle": "Naturally curious, I'm passionate about the web and particularly the front end part. Web development, graphic design, multimedia production and communication have been an integral part of my studies. I speak French, English and have studied Spanish. My hobbies ?",
  ...
  fr: {
    ...
    "meta_description": "Louis Grasset, développeur web front end freelance. Développement adapté à vos besoins.",
    "language_label": "Français",
    "language_code": "fr_FR",
    "alert_contact_text": "Votre message a bien été envoyé.",
    "modal_contact_title": "Brisons la glace !",
    "modal_contact_subtitle": "Vous êtes plutôt réseaux sociaux ou formulaire ? C'est comme vous préférez.",
    ...
    "modal_contact_form_honeypot": "Ne remplissez pas ce champ si vous êtes humain.",
    ...
    "workshop_headline_subtitle": "Projets annexes sur lesquels j'ai travaillé",
    ...
    "studies_mastercim_label": "Master 2 Conception et Intégration Multimédia",
    ...
    "about_headline_subtitle": "Curieux de nature, je suis passionné par le web et particulièrement son aspect front end. Développement web, conception graphique, production multimédia et communication ont fait partie intégrante de mes études. Je parle français, anglais et ai étudié l'espagnol. Mes hobbies ?",
