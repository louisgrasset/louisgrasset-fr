...
const Nav = () => {
    ...
    return (
        <nav className={(scrolling ? "bg-white border xl:bg-transparent" : "") + " fixed top-0 flex justify-between items-center w-full p-3 z-50 px-5  md:px-10 xl:px-20  border-gray-200"} >
