    ...
    return (
        <nav className={"fixed top-0 left-0 w-full py-3 z-40 px-5  md:px-10 xl:px-20"}>
            ...
            <div style={{ gridTemplateColumns: `24px 1fr ${socials.length * 36}px` }} className="grid items-center grid-flow-col">
                <img src={require('../../images/profile.webp').default} alt="Louis Grasset" className={(!scrolling ? "scale-0" : "scale-1 xl:hidden") + " duration-200 transition-all bg-transparent transform w-6 h-6 rounded-full shadow-md"} />
