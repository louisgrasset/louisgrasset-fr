...
export const Hero = ({ refs, toggleContactModal, lang }) => {
    return (
        <div className="pt-20">
            ...
            <p className="my-8 text-gray-500 font-theme text-md"><span className="mr-2">{lang.hero.position} <a href="https://yseop.com" className="underline"><img className="inline h-6 -mt-1.5  dark:filter-brightness-100" src={company} alt="Yseop" /></a> &amp; freelance.</span><img src={iconPin} alt="Epingle" className="inline dark:filter-invert w-3.5 h-3.5 -mt-0.5 opacity-30" /> Lyon, France.</p>
