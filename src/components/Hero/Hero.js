    ...
    return (
        <div className="pt-20">
            ...
            <h1 className="text-4xl font-medium text-gray-900 dark:text-gray-200 sm:text-6xl md:text-7xl lg:text-8xl">
                <span className="font-semibold text-black dark:text-white">Louis Grasset</span> <span className="invisible block text-sm md:visible md:inline-block md:text-7xl lg:text-8xl">—</span> Développeur web front end passionné. Je&nbsp;croque le web.<br />
            </h1>
            <p className="my-8 text-gray-500 font-theme text-md"><span className="mr-2">Actuellement en poste de Développeur R&amp;D chez <a href="https://yseop.com" className="underline"><img className="inline h-6 -mt-1.5  dark:filter-brightness-100" src={company} alt="Yseop" /></a> et freelance.</span><img src={iconPin} alt="Epingle" className="inline dark:filter-invert w-3.5 h-3.5 -mt-0.5 opacity-30" /> Lyon, France.</p>
