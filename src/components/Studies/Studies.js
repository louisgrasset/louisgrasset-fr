                ...
                studies.map((diploma, key) => {
                    ...
                    return (
                        <div key={key} className="flex flex-col items-start gap-12 lg:items-center lg:flex-row gap-y-4">
                            <img src={require(`../../images/studies/${diploma.institution.slug}.svg`).default} alt={diploma.institution.name} width="100" height="50" className="w-24 h-12 lg:w-30 dark:filter-companies" />
