                    ...
                    <article className="relative p-4 pb-2 bg-gray-100 rounded-md dark:bg-gray-800">
                        <picture>
                            <source
                                ...
                                srcSet={`/images/workshop/${project.slug}/${project.slug}-1.thumb.webp`}
                                media="(max-width: 420px)"
                            />
                            <source
                                className="object-fit aspect-video rounded-md h-full w-full"
                                srcSet={`/images/workshop/${project.slug}/${project.slug}-1.webp`}
                        ...
                        <span className="absolute text-gray-500 bottom-2 right-4">
                            {project.year}
                        </span>
                    </article>
                </a>
