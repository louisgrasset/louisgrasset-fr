...
const ContactModal = (props) => {
    ...
    return (
        <div className={(props.show ? "flex" : "hidden") + " items-start fixed top-0 left-0 md:items-center justify-center w-full h-screen backdrop-blur-5 z-50"}>
            ...
            <div className="container relative grid max-w-xl max-h-screen gap-8 p-10 mt-5 overflow-y-auto bg-white shadow-2xl md:mt-0 overscroll-contain xl:gap-0 xl:max-w-3xl rounded-xl xl:grid-cols-2">
